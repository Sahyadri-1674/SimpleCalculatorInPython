...
# e.place(x=5, y=10, width=65, height=30)
...
btn_add = Button(root,text="+",padx=42,pady=20,command=button_add,font=12)
...
btn_mul = Button(root,text="x",padx=42,pady=20,command=button_mul,font=12)
btn_equal = Button(root,text="=",padx=100,pady=20,command=button_equal,bg="lightblue",font=12)
btn_clear = Button(root,text="Clear",padx=85,pady=20,command=button_clear,font=12)
btn_dot = Button(root,text=".",padx=40,pady=20,command=lambda:button_click("."),font=12)
btn_end = Button(root,text="END",padx=38,pady=22,command=butn_end,bg="red")
